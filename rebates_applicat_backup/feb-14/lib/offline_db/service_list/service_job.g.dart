...
part of 'service_job.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class ServiceJobsAdapter extends TypeAdapter<ServiceJobs> {
  @override
  final int typeId = 4;

  @override
  ServiceJobs read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, ServiceJobs obj) {
    writer
      ..writeByte(18)
      ..writeByte(0)
      ..write(obj.id)
