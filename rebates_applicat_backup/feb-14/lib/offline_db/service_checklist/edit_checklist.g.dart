...
class OfflineServiceChecklistItemAdapter
    extends TypeAdapter<OfflineServiceChecklistItem> {
  @override
  final int typeId = 30;

  @override
  OfflineServiceChecklistItem read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return OfflineServiceChecklistItem(
  ...
  @override
  void write(BinaryWriter writer, OfflineServiceChecklistItem obj) {
    writer
      ..writeByte(12)
      ..writeByte(0)
      ..write(obj.userId)
  ...
  bool operator ==(Object other) =>
      ...
      other is OfflineServiceChecklistItemAdapter &&
