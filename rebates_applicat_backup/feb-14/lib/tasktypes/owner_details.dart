...
class EditOwnerDetailsScreen extends StatefulWidget {
  ...
  final List<Map<String, dynamic>> partner_items;
  ...
  EditOwnerDetailsScreen(
      {required this.premises,
      required this.storeys,
      required this.wall_type,
      required this.roof_type,
      required this.meterBoxPhase,
      required this.project_id,
      required this.partner_items,
  ...
  @override
  _EditOwnerDetailsScreenState createState() => _EditOwnerDetailsScreenState();
}

class _EditOwnerDetailsScreenState extends State<EditOwnerDetailsScreen> {
  late String selectedPropertyType;
  String selectedOwnerType = 'Individual';
  ...
  void initState() {
    ...
    selectedPropertyType = widget.premises == 'Unknown' ? '' : widget.premises;

    selectedOwnerType = widget.partner_items.isNotEmpty &&
            widget.partner_items[0]['company_type'] is String &&
            widget.partner_items[0]['company_type'] != null
        ? (widget.partner_items[0]['company_type'] == 'person'
            ? 'Individual'
            : 'Company')
        : 'Individual';

    if (widget.partner_items.isNotEmpty) {
      nameController.text = (widget.partner_items[0]['name'] is String)
          ? widget.partner_items[0]['name']
          : '';
      phoneController.text = (widget.partner_items[0]['phone'] is String)
          ? widget.partner_items[0]['phone']
          : '';
      emailController.text = (widget.partner_items[0]['email'] is String)
          ? widget.partner_items[0]['email']
          : '';
    } else {
      nameController.text = '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // appBar: AppBar(
      //   title: Text('Owner & Premises Details',
      //       style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
      //   backgroundColor: Colors.green,
                        ...
                        Column(
                          ...
                          children: [
                              ...
                              children: [
                                Text('Owner Type',
                                    style: TextStyle(
                                        ...
                                        fontWeight: FontWeight.bold)),
                                Text(
                                  selectedOwnerType ?? 'Select Owner Type',
                                  style: TextStyle(
                                      color: selectedOwnerType != null
                                          ? Colors.black
                                          : Colors.grey),
                                ),
                              ],
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text('How many storeys',
                                    style: TextStyle(
                                        color: Colors.black,
                                        fontWeight: FontWeight.bold)),
                                SizedBox(width: 8),
                                Text(
                                  widget.storeys?.isNotEmpty == true
                                      ? widget.storeys!
                                      : "No storeys available",
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 8),
                                Text(
                                  widget.wall_type?.isNotEmpty == true
                                      ? widget.wall_type!
                                      : "No storeys available",
                                  style: TextStyle(fontWeight: FontWeight.bold),
                                ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 8),
                                Text(
                                  widget.roof_type?.isNotEmpty == true
                                      ? widget.roof_type!
                                      : "No Roof type available",
                                  style: TextStyle(fontWeight: FontWeight.bold),
                                ),
                              ],
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 8),
                                Text(
                                  widget.meterBoxPhase?.isNotEmpty == true
                                      ? widget.meterBoxPhase!
                                      : "No Meter box phase available",
                                  style: TextStyle(fontWeight: FontWeight.bold),
                                ),
                              ],
                            ),
                            ...
                            Row(
                              children: [
                                Expanded(
                                    child: Text(
                                        'Additional/Upgrade System Information',
                                        style: TextStyle(
                                            color: Colors.black,
                                            fontWeight: FontWeight.bold))),
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      widget.mountingWallType?.isNotEmpty ==
                                              true
                            ...
                            if (inverterLocationDocumet != null ||
                              ...
                              if (switchBoardDocumet != null)
                                Padding(
                                  padding: EdgeInsets.all(6.0),
                                  child: _buildPdfCertificateTile(context,
                                      "Switch Board Photo", switchBoardDocumet),
                                ),
                              if (solarPanelDocumet != null)
                                Padding(
                                  padding: EdgeInsets.all(6.0),
                                  child: _buildPdfCertificateTile(context,
                                      "Solar Panel Layout", solarPanelDocumet),
                                ),
                            ],
                          ],
                        ),
  ...
  Future<void> _saveOwnerDetails(
      Map<String, dynamic> updatedDetails,
      Map<String, dynamic> updatedPropertyDetails,
      int id,
    ...
    try {
      ...
      if (partnerResponse == true) {
        final taskResponse = await client?.callKw({
          'model': 'project.task',
          'method': 'write',
          'args': [
            [project_id],
        ...
        if (taskResponse == true) {
          ...
          setState(() {
            _isLoading = false;
            _errorMessage = "Failed to save property type. Please try again.";
          });
        }
        // }
        // if (partnerResponse == true) {
  ...
  Widget _buildPropertyTypeButton(String label, IconData icon) {
    return Container(
      ...
      child: GestureDetector(
        // onTap: () => setState(() => selectedPropertyType = label),
        child: Container(
          padding: EdgeInsets.symmetric(vertical: 10),
          decoration: BoxDecoration(
            color: selectedPropertyType == label
